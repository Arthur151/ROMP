...
class KalmanFilter(object):
    ...
    def initiate(self, measurement):
        ...
        std = [2 * self._std_weight_position * measurement[self.ndim-1] for _ in range(self.ndim)] +\
            [10 * self._std_weight_velocity * measurement[self.ndim-1] for _ in range(self.ndim)]
