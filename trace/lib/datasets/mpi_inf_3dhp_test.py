...
def MPI_INF_3DHP_TEST(base_class=default_mode):
    class MPI_INF_3DHP_TEST(Base_Classes[base_class]):
        def __init__(self,train_flag=False, joint_format='smpl24', **kwargs):
            ...
            self.kp2d_mapper = constants.joint_mapping(constants.MPI_INF_TEST_17,constants.SMPL_ALL_44)
            self.kp3d_mapper = constants.joint_mapping(constants.MPI_INF_TEST_17,constants.SMPL_ALL_44)
            self.root_inds = [constants.SMPL_ALL_44['Pelvis']] #[constants.SMPL_ALL_44['R_Hip'], constants.SMPL_ALL_44['L_Hip']] 
        ...
        def get_image_info(self, index):
            ...
            img_info = {'imgpath': imgpath, 'image': image, 'kp2ds': kp2ds, 'track_ids': None,\
                    'vmask_2d': np.array([[True,False,True]]), 'vmask_3d': np.array([[True,False,False,False,False,True]]),\
...
if __name__ == '__main__':
    datasets=MPI_INF_3DHP_TEST(base_class=default_mode)(train_flag=False)
    Test_Funcs[default_mode](datasets)
    print('Done')
