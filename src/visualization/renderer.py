...
sys.path.append(os.path.abspath(__file__).replace('visualization/renderer.py',''))
import config
import constants
...
def get_renderer(test=False,model_type='smplx',resolution = (512,512,3),part_segment=False):
