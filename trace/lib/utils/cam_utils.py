...
def process_cam_params(cam_maps):
    ...
    #cam_maps[..., 0] = torch.clamp(cam_maps[..., 0], 0, 1)
    #cam_maps[..., 1:] = torch.clamp(cam_maps[..., 1:], -1, 1)
    return cam_maps
...
def convert_trans2cam(trans, fovs=1/tan_fov):
    normed_cams = torch.zeros_like(trans)
    #tan_fov = np.tan(np.radians(args().FOV/2.))
    normed_cams[...,0] = fovs / trans[...,2]
    normed_cams[...,1] = fovs * trans[...,1] / trans[...,2]
    normed_cams[...,2] = fovs * trans[...,0] / trans[...,2]
    return normed_cams
